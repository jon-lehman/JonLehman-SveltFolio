...
var app = (function () {
    ...
    /* src\Section.svelte generated by Svelte v3.44.1 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 21, 8, 341);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 19, 0, 309);
    		},
    ...
    /* src\Link.svelte generated by Svelte v3.44.1 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			br = element("br");
    			add_location(br, file$3, 55, 4, 1986);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 49, 4, 1339);
    			attr_dev(path, "fill", "var(--text-secondary-color)");
    			attr_dev(path, "fill-rule", "evenodd");
    			attr_dev(path, "d", "M7.917 1.333a.5.5 0 110-1h4.25a.5.5 0 01.5.5v4.25a.5.5 0 01-1 0V2.04l-6.23 6.23a.5.5 0 01-.707-.707l6.23-6.23H7.917zm-7.022.978c.36-.359.847-.561 1.355-.561h2.833a.5.5 0 110 1H2.25a.917.917 0 00-.917.917v7.083a.917.917 0 00.917.917h7.083a.917.917 0 00.917-.917V7.917a.5.5 0 011 0v2.833a1.917 1.917 0 01-1.917 1.917H2.25A1.916 1.916 0 01.333 10.75V3.667c0-.509.202-.996.562-1.356z");
    			attr_dev(path, "clip-rule", "evenodd");
    			add_location(path, file$3, 51, 8, 1470);
    			...
    			add_location(svg, file$3, 50, 4, 1365);
    			attr_dev(a, "href", /*url*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "class", "svelte-tmkr3m");
    			add_location(a, file$3, 48, 0, 1303);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\ProfileMedia.svelte generated by Svelte v3.44.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			if (!src_url_equal(source0.src, source0_src_value = "https://firebasestorage.googleapis.com/v0/b/jonlehman-me.appspot.com/o/JonLehman_Profile_SHORT.webm?alt=media&token=91776b1f-fdcd-4ade-ae2e-f02ad16c717d")) attr_dev(source0, "src", source0_src_value);
    			attr_dev(source0, "type", "video/webm");
    			add_location(source0, file$2, 27, 4, 756);
    			if (!src_url_equal(source1.src, source1_src_value = "https://firebasestorage.googleapis.com/v0/b/jonlehman-me.appspot.com/o/JonLehman_Profile_SHORT.mp4?alt=media&token=83658efd-3d83-45a4-a749-904311838e48")) attr_dev(source1, "src", source1_src_value);
    			attr_dev(source1, "type", "video/mp4");
    			add_location(source1, file$2, 28, 4, 948);
    			if (!src_url_equal(img.src, img_src_value = "https://firebasestorage.googleapis.com/v0/b/jonlehman-me.appspot.com/o/JonLehman_Profile_Fallback.jpg?alt=media&token=3aff2d02-9c05-484f-94a7-a8dc4d8f5c09")) attr_dev(img, "src", img_src_value);
    			add_location(img, file$2, 30, 4, 1189);
    			...
    			add_location(video_1, file$2, 26, 0, 488);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ProfileMedia> was created with unknown prop '${key}'`);
    	});
    ...
    /* src\Title.svelte generated by Svelte v3.44.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 24, 4, 390);
    			attr_dev(h2, "class", "reduced svelte-1n7febq");
    			add_location(h2, file$1, 25, 4, 422);
    			attr_dev(div, "class", "svelte-1n7febq");
    			add_location(div, file$1, 23, 0, 379);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (88:2) {#each data.previousJobs as job}
    function create_each_block_3(ctx) {
    	let p;
    	let t_value = /*job*/ ctx[9].text + "";
    	let t;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(88:2) {#each data.previousJobs as job}",
    		ctx
    	});
    ...
    // (87:1) <Section label={"Previously"}>
    function create_default_slot_3(ctx) {
    	let each_1_anchor;
    	let each_value_3 = data.previousJobs;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 0) {
    				each_value_3 = data.previousJobs;
    				validate_each_argument(each_value_3);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(87:1) <Section label={\\\"Previously\\\"}>",
    		ctx
    	});
    ...
    // (94:2) {#each data.projects as project}
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(94:2) {#each data.projects as project}",
    		ctx
    	});
    ...
    // (93:1) <Section label={"Personal Projects"}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(93:1) <Section label={\\\"Personal Projects\\\"}>",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(100:2) {#each data.notes as note}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(99:1) <Section label={\\\"Notes\\\"}>",
    		ctx
    	});
    ...
    // (106:2) {#each data.socials as social}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(106:2) {#each data.socials as social}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(105:1) <Section label={\\\"Socials\\\"}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(html, file, 65, 1, 1534);
    			attr_dev(link0, "rel", "preconnect");
    			attr_dev(link0, "href", "https://fonts.gstatic.com");
    			add_location(link0, file, 66, 1, 1555);
    			...
    			add_location(link1, file, 67, 1, 1614);
    			attr_dev(div0, "class", "sticky svelte-2tr7xb");
    			add_location(div0, file, 74, 1, 1816);
    			attr_dev(div1, "class", "container svelte-2tr7xb");
    			add_location(div1, file, 70, 0, 1766);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

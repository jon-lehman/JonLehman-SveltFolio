...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			br = element("br");
    			add_location(br, file$3, 55, 4, 2036);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = `${data.previousJob.text}`;
    			attr_dev(p, "class", "svelte-2tr7xb");
    			add_location(p, file, 87, 2, 2048);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (92:2) {#each data.projects as project}
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(92:2) {#each data.projects as project}",
    		ctx
    	});
    ...
    // (91:1) <Section label={"Personal Projects"}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(91:1) <Section label={\\\"Personal Projects\\\"}>",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:2) {#each data.notes as note}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(97:1) <Section label={\\\"Notes\\\"}>",
    		ctx
    	});
    ...
    // (104:2) {#each data.socials as social}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(104:2) {#each data.socials as social}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(103:1) <Section label={\\\"Socials\\\"}>",
    		ctx
    	});
